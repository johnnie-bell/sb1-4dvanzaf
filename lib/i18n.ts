...
export const translations: Record<Language, Translations> = {
  ...
  es: {
    ...
    // Hero
    heroTitle: 'Listo para vacaciones en un clic.',
    heroSubtitle: 'Desde artículos de playa hasta ayudas de movilidad, alquila todo lo que necesitas para la experiencia de vacaciones perfecta.',
  ...
  fr: {
    ...
    // Hero
    heroTitle: 'Prêt pour les vacances en un clic.',
    heroSubtitle: 'Des essentiels de plage aux aides à la mobilité, louez tout ce dont vous avez besoin pour une expérience de vacances parfaite.',
  ...
  nl: {
    ...
    // Hero
    heroTitle: 'Vakantie-klaar met één klik.',
    heroSubtitle: 'Van strandbenodigdheden tot mobiliteitshulpmiddelen, huur alles wat je nodig hebt voor de perfecte vakantie-ervaring.',
